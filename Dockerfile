...
RUN curl -fsSL -o go_amd64.tar.gz "https://go.dev/dl/go1.21.1.linux-amd64.tar.gz"
RUN curl -fsSL -o go_arm64.tar.gz "https://go.dev/dl/go1.21.1.linux-arm64.tar.gz"
