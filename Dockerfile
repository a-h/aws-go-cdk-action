...
RUN curl -fsSL -o go_amd64.tar.gz "https://go.dev/dl/go1.21.0.linux-amd64.tar.gz"
RUN curl -fsSL -o go_arm64.tar.gz "https://go.dev/dl/go1.21.0.linux-arm64.tar.gz"
...
# Install CDK.
RUN npm install -g aws-cdk@2.105.0 typescript
